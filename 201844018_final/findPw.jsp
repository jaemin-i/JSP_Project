...
<form action="lookupStupwProc.jsp" style="margin-top:-15px;" name="frm" onsubmit="return check()">
<br>
<div style="margin-bottom:10px;">
<h2 align="center"> 비밀번호 찾기 </h2>
학&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;번&nbsp;&nbsp;:&nbsp;&nbsp;<input type="text" name="stuno" style="width:140px; height:20px; font-size:13px;" autofocus="autofocus"><br>
